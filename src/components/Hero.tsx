...
const Hero = () => {
  ...
  return (
    <section
      className="relative overflow-hidden bg-gradient-to-b from-background to-blue-50/30 py-20 sm:py-32"
      style={{
        backgroundImage: `url("/image/graduation.jpg")`,
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Main heading */}
         <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-100 mb-6 animate-slide-up">
  ...
  <span>en quelques clics</span>
          ...
          {/* Subtitle */}
         <p className="text-xl text-gray-200 max-w-2xl mx-auto mb-10 animate-fade-in">
  ...
  <div className="text-center animate-bounce-in">
    ...
    <div className="text-4xl font-extrabold text-primary drop-shadow-sm">
      <Counter prefix="+" end={50000} duration={2500} />
    </div>
    <div className="text-sm text-white">Lycéens accompagnés</div>
  </div>
  <div className="text-center animate-bounce-in" style={{ animationDelay: '0.2s' }}>
    ...
    <div className="text-4xl font-extrabold text-primary drop-shadow-sm">
      <Counter prefix="+" end={200} duration={2000} />
    </div>
    <div className="text-sm text-white">Universités partenaires</div>
  </div>
  <div className="text-center animate-bounce-in" style={{ animationDelay: '0.4s' }}>
    ...
    <div className="text-4xl font-extrabold text-primary drop-shadow-sm">
      <Counter prefix="+" end={95} suffix="%" duration={1800} />
    </div>
