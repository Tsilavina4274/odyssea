    ...
    try {
      ...
      if (success) {
        toast({
          ...
          description: "Bienvenue sur Odysséa !",
        });
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/10 to-purple-100/20 flex items-center justify-center p-4">
      <Card className="w-full max-w-md shadow-lg">
        <CardHeader className="text-center space-y-4">
          ...
          <CardTitle className="text-2xl font-bold">Connexion à Odysséa</CardTitle>
          <p className="text-muted-foreground">Accédez à votre espace d'orientation</p>
        </CardHeader>
